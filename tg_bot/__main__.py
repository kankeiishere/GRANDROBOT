...
TECHNO_IMG = "https://telegra.ph/file/a82822eca6cf04a855e5e.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/anobutglobal_bot")],
                                                                                   [InlineKeyboardButton(text="ADD 4n0nym0u5 global b0t🤖 TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username))
                                                                                 ]]))

    else:
        update.effective_message.reply_text("hello I'm a bot created by 4n0nym0u5~π and I'm online")
